...
2. Install [Python](https://www.python.org/downloads/) if you don't. If you're on Windows, follow [this](WINDOWS_INSTALL.md) guide. If you're on Mac, I suggest using [Homebrew](https://brew.sh) to manage it.
